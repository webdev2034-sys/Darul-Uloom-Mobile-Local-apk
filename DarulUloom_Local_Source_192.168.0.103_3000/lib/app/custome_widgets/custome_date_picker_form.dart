...
import 'custome_textbox_label_form.dart';

class CustomeDatePickerForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomeTextBoxLabelForm(
      ...
      suffixIcon: const Icon(
        Icons.date_range,
        size: 20,
        color: Color.fromARGB(255, 81, 82, 87),
      ),
    );
  }
}
